...
# opcional — usado para validar webhook futuramente
...
MELHOR_ENVIO_SANDBOX = os.getenv(
...
MELHOR_ENVIO_PUBLIC_URL = (
    os.getenv("MELHOR_ENVIO_PUBLIC_URL") or ""
).rstrip("/")
...
MELHOR_ENVIO_USER_AGENT = os.getenv(
    ...
    "Moldz3D (contato@exemplo.com)"
)

MELHOR_ENVIO_OAUTH_SCOPE = (
    os.getenv("MELHOR_ENVIO_OAUTH_SCOPE") or ""
).strip()

# =========================
# REMETENTE MELHOR ENVIO
# =========================
